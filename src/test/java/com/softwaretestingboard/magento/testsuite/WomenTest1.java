...
public class WomenTest1 extends BaseTest {
    ...
    WomensPage womenPage = new WomensPage();
    ...
    public void verifyTheSortByProductNameFilter() throws InterruptedException {
        ...
        ArrayList<String> actualList = getArrayListOfStringsFromWebElements(womenPage.sortingJacketsList());
        System.out.println("Actual Jackets List : " + actualList);
        ArrayList<String> expectedList = getArrayListOfStringsFromWebElements(womenPage.sortingJacketsList());
    ...
    public void verifyTheSortByPriceFilter() throws InterruptedException {
        ...
        ArrayList<String> actualList = getArrayListOfStringsFromWebElements(womenPage.sortingInPriceList());
        System.out.println("Actual Price List : " + actualList);
        ArrayList<String> expectedList = getArrayListOfStringsFromWebElements(womenPage.sortingInPriceList());
